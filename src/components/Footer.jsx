  ...
  return (
    <footer className="bg-white text-black dark:bg-[#272727CC] dark:text-black">
      <div className="w-full flex flex-col lg:flex-row gap-2 mx-auto">
        {/* Main Footer Content */}
        <div className="w-full border-t-2 lg:w-2/3 border-2 p-4 bg-gray-100 flex flex-col justify-center items-center space-y-6 dark:bg-[#0A0A0C] dark:text-white bg-gradient-to-r from-gray-600 via-gray-800 to-gray-900 text-white">
          {/* Footer Sections */}
        ...
        <div className="w-full lg:w-1/3 flex flex-col space-y-2">
          <div className="border-2 p-4 bg-gray-100 flex flex-col justify-center items-center space-y-3 h-1/2 dark:bg-[#0A0A0C] dark:text-white bg-gradient-to-r from-gray-600 via-gray-800 to-gray-900 text-white">
          ...
          <div className="flex justify-center items-center space-x-4 text-3xl p-4 border-2 bg-gray-100 h-1/2 dark:bg-[#0A0A0C] dark:text-white bg-gradient-to-r from-gray-600 via-gray-800 to-gray-900 text-white">
            <FaApplePay />
            <FaCcVisa />
            <FaCcMastercard />
            <FaCcAmex />
